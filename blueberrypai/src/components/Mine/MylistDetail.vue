		...
		<div class="main">
			<div class="mod_data">
				<span class="data__cover">
					 <img id="albumImg" :src="mylistinfo.listCover" class="data__photo">
				</span>
				<div class="data__cont">
					<div class="data__name">
						<h1 class="data__name_txt">{{mylistinfo.listname}}</h1>
					</div>
	
					<div class="data__singer">
						<i class="icon_singer"></i>
						<a href="javascript:;"
									   class="data__singer_txt">{{nickname}}</a>
					</div>
					<ul class="data__info">
...
export default {
	...
	methods:{
        ...
        playlist(){
				var num = localStorage.getItem('currlistNum');
	...
	mounted() {
		...
		this.mylistinfo=JSON.parse(localStorage.mylist)[id];
