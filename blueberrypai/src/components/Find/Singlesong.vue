		...
		<div class="main">
			<div class="mod_data">
				<span class="data__cover">
			                <img id="albumImg" :src="songinfo.albumcover" class="data__photo">
			            </span>
				<div class="data__cont">
					<div class="data__name">
						<h1 class="data__name_txt">{{songinfo.songname}}</h1>
					</div>
	
					<div class="data__singer">
						<i class="icon_singer"></i>
						<a href="javascript:;"
						   class="data__singer_txt">{{songinfo.author}}</a>
					</div>
					...
					<ul class="data__info">
						...
						<li>发行时间：2017-03-31</li>
	
						<li>发行公司：
							<a href="javascript:;">华纳PLG</a>
						</li>
						<li>类型：Single</li>
					</ul>
							...
							<li>
								<div class="songlist__item">
									...
									<div class="songlist__songname">
										<span class="songlist__songname_txt">{{songinfo.songname}}</span>
										<i class="songlist__icon songlist__icon_exclusive"></i>
									</div>
									<div class="songlist__artist">
										<a href="javascript:;"
										   class="singer_name">{{songinfo.author}}</a>
									</div>
									<div class="songlist__opt">{{songinfo.album}}</div>
...
<script>
	export default{
		...
		mounted(){
			var id=localStorage.getItem('currsongid');
			var api=localStorage.getItem('currsongapi');
